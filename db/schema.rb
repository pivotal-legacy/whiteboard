...
ActiveRecord::Schema.define(version: 2016_01_26_220717) do
  ...
  create_table "posts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.timestamp "blogged_at"
    t.boolean "archived", default: false
    t.integer "standup_id"
    t.string "blog_post_id"
  end

  create_table "standups", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "title"
